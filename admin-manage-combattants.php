...
<div id="content" class="ml-15% p-4" style="padding-top: 5rem;">
    ...
    </div>        <!-- Grille pour les cartes de combattants -->
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
        <?php foreach ($combattants as $combattant): ?>
            <div class="bg-gray-700 rounded-xl shadow-xl p-4" style="width: 200px; height: 350px;">
                <img src="<?= htmlspecialchars($combattant['image']) ?: 'path/to/default-image.png' ?>" alt="<?= htmlspecialchars($combattant['nom']) ?>" class="w-full h-40 object-cover rounded-t-lg">
                <div class="text-center mt-2">
                    <h3 class="text-lg font-bold"><?= htmlspecialchars($combattant['nom']) ?></h3>
                    <p class="text-sm"><?= htmlspecialchars($combattant['description']) ?></p>
                    <div class="mt-4">
